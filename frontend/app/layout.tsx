          ...
          <header className="fixed top-0 left-0 right-0 z-50 border-b border-slate-200 bg-white/95 backdrop-blur-xl shadow-sm">
            <div className="max-w-5xl mx-auto px-6 h-14 flex items-center justify-between">
              ...
              <nav className="flex items-center gap-1">
                <Link href="/" className="px-3.5 py-1.5 text-sm text-slate-600 font-medium rounded-lg hover:text-slate-900 hover:bg-slate-100 transition-all">
                  Home
                </Link>
                <Link href="/submit" className="px-3.5 py-1.5 text-sm text-slate-600 font-medium rounded-lg hover:text-slate-900 hover:bg-slate-100 transition-all">
                  Submit claim
                </Link>
                <Link href="/status" className="px-3.5 py-1.5 text-sm text-slate-600 font-medium rounded-lg hover:text-slate-900 hover:bg-slate-100 transition-all">
                  Track claim
                </Link>
              </nav>
            </div>
